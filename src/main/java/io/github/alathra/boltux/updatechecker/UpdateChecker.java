package io.github.alathra.boltux.updatechecker;
...
public class UpdateChecker implements Reloadable {
    ...
    public void onEnable() {
        setPluginName(BoltUX.getInstance().getPluginMeta().getName());
        setCurrentVersion(SemanticVersion.of(BoltUX.getInstance().getPluginMeta().getVersion()));
        performUpdateCheck();
    }
